...
import Icon from 'react-native-vector-icons/MaterialIcons'; // Importa MaterialIcons para los iconos
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContent}>
            <Text style={styles.modalText}>
              ¿Estás seguro de que deseas {selectedAction?.action?.toLowerCase()} al beneficiario con ID: {selectedAction?.id}?
            </Text>
...
const styles = StyleSheet.create({
  ...
  beneficiaryItem: {
    flexDirection: 'row', // Alinea el texto y los iconos horizontalmente
    alignItems: 'center',
    padding: 12,
    backgroundColor: '#fff',
    borderRadius: 8,
